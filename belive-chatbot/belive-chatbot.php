<?php
/**
 * Plugin Name:       Be.live — הסוכן החכם למערכות יחסים
 * Plugin URI:        https://ronishe.co.il
 * Description:       הסוכן הדיגיטלי של Be.live, המרכז למערכות יחסים מבית רוני שינקמן. מלווה מנויים בעברית בוואטסאפ ובאתר לפי הגישה של רוני: עוזר לעשות סדר, לזהות דפוסים ולבחור צעד קטן, עם כללי בטיחות והעברה לצוות אנושי. מהדורת Be.live מבוססת מנוע Wisply של Goldstein Studio.
 * Version:           1.0.0
 * Requires at least: 6.0
 * Requires PHP:      8.1
 * Author:            Goldstein Studio
 * Author URI:        https://goldstein.studio
 * License:           Proprietary — Be.live / ronishe.co.il only
...
// White-label product name (shown in admin menu + "Powered by"). Be.live edition.
defined( 'WISPLY_PRODUCT_NAME' ) || define( 'WISPLY_PRODUCT_NAME', 'Be.live' );
...
require_once WISPLY_PLUGIN_DIR . 'includes/class-belive-profile.php';
...
add_action( 'plugins_loaded', function () {
    ...
    // Be.live edition: seed Roni Shinkman's persona + config once per profile version.
    Belive_Profile::get_instance();
