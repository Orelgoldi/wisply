...
$base  = admin_url( 'admin.php?page=wisply-conversations' );
...
<div class="wrap wisply-admin" dir="rtl" style="font-family:'Open Sans Hebrew',Arial,sans-serif">
    ...
    <?php else : ?>
        ...
        <form method="get" style="background:#f9f9f9;padding:14px 16px;border-radius:8px;margin:16px 0;display:flex;gap:14px;align-items:center;flex-wrap:wrap">
            <input type="hidden" name="page" value="wisply-conversations">
            <label>שפה:
                <select name="lang">
            ...
            <a class="button" href="<?php echo esc_url( rest_url( 'wisply/v1/admin/export' ) . '?_wpnonce=' . wp_create_nonce( 'wp_rest' ) ); ?>">ייצוא CSV</a>
        </form>
