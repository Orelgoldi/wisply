            ...
            <tr>
                ...
                <td>
                    <input type="number" name="desktop_autoopen_delay" min="0" max="120"
                           value="<?php echo m360_v('desktop_autoopen_delay','3'); ?>" class="small-text"> שניות
                </td>
            </tr>
            <tr>
                <th>הודעת פתיחה — עברית</th>
                <td><input type="text" name="desktop_autoopen_msg_he" class="large-text" value="<?php echo m360_v('desktop_autoopen_msg_he'); ?>"></td>
            </tr>
            <tr>
                <th>הודעת פתיחה — English</th>
                <td><input type="text" name="desktop_autoopen_msg_en" class="large-text" value="<?php echo m360_v('desktop_autoopen_msg_en'); ?>"></td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td>
                    <input type="url" name="logicare_base_url" class="regular-text" dir="ltr"
                           value="<?php echo m360_v('logicare_base_url'); ?>" placeholder="https://app.logicare.co.il">
