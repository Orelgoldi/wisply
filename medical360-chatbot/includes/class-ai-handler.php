...
class M360_AI_Handler {
    ...
    public function get_reply( string $user_message, string $lang, array $history = [], int $turn = 0 ): array {
        ...
        $result = match ( $provider ) {
            'openai' => $this->call_openai( $user_message, $lang, $history, $docs, $turn ),
            default  => $this->call_claude( $user_message, $lang, $history, $docs, $turn ),
        };
    ...
    private function call_claude( string $user_message, string $lang, array $history, array $docs, int $turn = 0 ): array {
        ...
        $system  = $this->build_system_prompt( $lang, $docs, $user_message, $turn );
    ...
    private function call_openai( string $user_message, string $lang, array $history, array $docs, int $turn = 0 ): array {
    ...
    private function build_system_prompt( string $lang, array $docs, string $query = '', int $turn = 0 ): string {
        $context_block = '';
        if ( ! empty( $docs ) ) {
            $context_block = "\n\n=== תוכן רלוונטי מהאתר ===\n";
